...
if __name__ == "__main__":
    train_path = "./person-in-bed-streaming-detection/train_transformed.json"
    test_path = "./person-in-bed-streaming-detection/streamingtest.json"

    train_dataset, test_dataset = load_data(train_path, test_path, window_size=250, step=250)
